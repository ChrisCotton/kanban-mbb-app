...
// Use processLock (in-memory) instead of the default navigatorLock. navigator.locks.request
// rejects with AbortError after ~10s on slow production cold-starts, which breaks getUser()/
// getSession()/signInWithPassword for every subsequent call in the tab.
// lockAcquireTimeout must exceed a stalled refresh_token round-trip; the library default
// (10s) causes "Lock acquisition timed out" storms and hung /calendar spinners on Vercel cold starts.
