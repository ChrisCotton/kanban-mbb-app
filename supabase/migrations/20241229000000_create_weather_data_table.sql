-- Supabase Migration: Create weather_data table for calendar integration
-- Date: 2024-12-29
-- This table stores daily weather information fetched from external APIs (n8n workflow)
