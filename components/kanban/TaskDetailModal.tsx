                ...
                <div>
                  ...
                  {isEditing ? (
                    <textarea
                      ...
                      className="w-full text-gray-600 dark:text-gray-400 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none"
                      rows={4}
                    ...
                    task.description && (
                      <div 
                        className="text-gray-600 dark:text-gray-400 whitespace-pre-wrap cursor-pointer hover:text-gray-800 dark:hover:text-gray-200 transition-colors p-2 rounded hover:bg-gray-50 dark:hover:bg-gray-700"
                        onClick={() => onUpdate && setIsEditing(true)}
                        title="Click to edit"
                      >
                        {task.description}
