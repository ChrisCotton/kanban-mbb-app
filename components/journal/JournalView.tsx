            ...
            <div className="space-y-6">
              ...
              {filteredEntries.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 mb-4">Start recording your thoughts and ideas to create your first journal entry.</p>
                  <button
                    onClick={() => setViewMode('record')}
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center space-x-4 text-xs text-gray-500">
                            ...
                            <span className={`px-2 py-1 rounded text-xs ${
                              entry.transcription_status === 'completed' ? 'bg-green-100 text-green-800' :
                              entry.transcription_status === 'processing' ? 'bg-yellow-100 text-yellow-800' :
                              entry.transcription_status === 'failed' ? 'bg-red-100 text-red-800' :
